...
* Protests against removal of a Robet E. Lee monument
...
* More accountable AI programming:
    ...
    + Include Feedback: possibility to appeal (restcricted times)
...
[**Data and Code can be found in this GitHub Repository**](https://github.com/favstats/DecodingTheAltRight)
