...
+ Comments from 6 Media Outles (CNN, MSNBC, ABC, Fox News, Washington Post, New York Times)
...
dat_time_xts %>% 
  mutate(perc = ifelse(platform == "YouTube" & cdate < as.Date("2017-06-01") & page == "Washington Post", NA, perc)) %>% 
  mutate(perc = ifelse(platform == "YouTube" & cdate < as.Date("2017-06-01") & page == "New York Times" & perc >= 10, 7, perc)) %>% 
...
> "Lol counter protesters that's what you get. Let the white people have there pride. I use the 2nd amendment so If they try something I'm strapped just leave them alone. There culture is being torn apart such as taking down the confederate monuments and stoping white pride events. Black people can parade  streets and have black pride. But not white people? The tables have turned. Honestly I really dislike niggers I wish we would have never brought them from Africa."
