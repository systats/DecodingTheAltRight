...
dat_time_xts %>% 
  ...
  # mutate(perc = ifelse(page == "New York Times" & cdate == as.Date("2017-01-04"), 2, perc)) %>% 
  # mutate(perc = ifelse(page == "New York Times" & cdate == as.Date("2017-01-17"), 2, perc)) %>% 
  # mutate(perc = ifelse(page == "Washington Post" & cdate == as.Date("2017-03-02"), 2, perc)) %>% 
  # mutate(perc = ifelse(page == "Washington Post" & cdate == as.Date("2017-04-07"), 2, perc)) %>% 
  # mutate(perc = ifelse(page == "Washington Post" & cdate == as.Date("2017-04-08"), 2, perc)) %>% 
  
mutate(perc = ifelse(page == "Washington Post" & cdate < as.Date("2017-06-01"), NA, perc)) %>%   
mutate(perc = ifelse(page == "New York Times" & cdate < as.Date("2017-06-01") & perc > 10, 7, perc)) %>% 
  highcharter::hchart(., "line", hcaes(x = cdate, y = perc, group = page)) %>% 
      hc_add_theme(hc_theme_google()) %>% 
